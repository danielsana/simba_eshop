...
app.secret_key ="123254365426nkghghdfhgfghfd@@#$"
...
def buy_products():
    ...
    sql_computers ='select * from products where product_category = "computers"'
    ...
    return render_template('buy_products.html', phones=phones, computers=computers, shoes=shoes)
